...
@SpringBootTest
public class BasicTenAlarmInParallelIntegrationTest {
    @Autowired
    ...
    @Test
    @Deployment(resources = { "processes/mybasicteninparallel.bpmn20.xml" })
    void startEndProcessTest() {
        Map<String, Object> variables = new HashMap<String, Object>();
        variables.put("alarmName","Alarm ten in parallel launched at "+new Date());
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey( "mybasicteninparallel", variables );
