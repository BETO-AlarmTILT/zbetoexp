...
@SpringBootTest
public class MyCallActivityTest {
    @Autowired
    ...
    @Test
    @Deployment(resources = { "processes/mycallactivity.bpmn20.xml" })
    void startEndProcessTest() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey( "mycallactivity", variables );
