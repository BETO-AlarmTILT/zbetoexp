...
@SpringBootTest
public class BasicAlarmIntegrationTest {
    @Autowired
    ...
    @Test
    @Deployment(resources = { "processes/mybasic.bpmn20.xml" })
    void startEndProcessTest() {
        Map<String, Object> variables = new HashMap<String, Object>();
        variables.put("alarmName","Alarm launched at "+new Date());
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey( "mybasic", variables );
